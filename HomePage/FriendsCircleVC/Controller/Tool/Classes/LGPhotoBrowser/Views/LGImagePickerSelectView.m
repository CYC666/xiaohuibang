...
- (id)init {
    if (self = [super init]) {
        ...
        [self.backBtn setImage:GetImage(@"btn_back_image") forState:UIControlStateNormal];
        ...
        [self.selectBtn setImage:GetImage(@"checkbox_pic_non") forState:UIControlStateNormal];
        [self.selectBtn setImage:GetImage(@"checkbox_pic") forState:UIControlStateSelected];
